...
scipy.misc.imsave( 'terrain_section_%d.png' % (time.clock() * 100 ), clouds(12))
scipy.misc.imsave( 'terrain_section_%d.png' % (time.clock() * 100 ), clouds(12))
scipy.misc.imsave( 'terrain_section_%d.png' % (time.clock() * 100 ), clouds(12))
scipy.misc.imsave( 'terrain_section_%d.png' % (time.clock() * 100 ), clouds(16))
scipy.misc.imsave( 'terrain_section_%d.png' % (time.clock() * 100 ), clouds(16))
scipy.misc.imsave( 'terrain_section_%d.png' % (time.clock() * 100 ), clouds(16))
scipy.misc.imsave( 'terrain_section_%d.png' % (time.clock() * 100 ), clouds(20))
scipy.misc.imsave( 'terrain_section_%d.png' % (time.clock() * 100 ), clouds(20))
scipy.misc.imsave( 'terrain_section_%d.png' % (time.clock() * 100 ), clouds(20))

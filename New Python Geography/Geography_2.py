...
def main():
    ...
    for i in range(1000,10000):
        ...
        print q,w,e,r,t
        eros = matrix_scale(erosion_water(main.heightmap(),5, q,w,e,r,t),0,100)
        imsave("rnd_"+str(q)+"_"+str(w)+"_"+str(e)+"_"+str(r)+"_"+str(t)+".png",eros)
        imsave("rnd_"+str(q)+"_"+str(w)+"_"+str(e)+"_"+str(r)+"_"+str(t)+"_broken.png",eros * 2.3 - spare* 0.7)
